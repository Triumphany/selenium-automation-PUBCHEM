import pytest
from pages.plot_density import PubChem_Periodic_Table_Density
import sys, os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))

screenshots_loc = os.path.join(os.path.dirname(__file__), "..", "screenshots", "Density")
os.makedirs(screenshots_loc, exist_ok=True)

@pytest.mark.usefixtures("setup")
class Test_element_Density:     
    def test_BY_value_attribute(self):
        page = PubChem_Periodic_Table_Density(self.driver)
