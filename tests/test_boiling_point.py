import pytest
from pages.plot_boiling_point import PubChem_Periodic_Table_Boiling_Point
import sys, os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))

screenshots_loc = os.path.join(os.path.dirname(__file__), "..", "screenshots", "Melting_point_plot")
os.makedirs(screenshots_loc, exist_ok=True)

@pytest.mark.usefixtures("setup")
class Test_element_boiling_point:     
    def test_BY_value_attribute(self):
        page = PubChem_Periodic_Table_Boiling_Point(self.driver)
