import pytest
from pages.plot_ionization import PubChem_Periodic_Table_Ionization_Energy
import sys, os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))

screenshots_loc = os.path.join(os.path.dirname(__file__), "..", "screenshots", "Ionization_energy_plot")
os.makedirs(screenshots_loc, exist_ok=True)

@pytest.mark.usefixtures("setup")
class Test_element_ionization_energy:     
    def test_BY_value_attribute(self):
        page = PubChem_Periodic_Table_Ionization_Energy(self.driver)
