import pytest
from pages.plot_melting_point import PubChem_Periodic_Table_Melting_Point
import sys, os
...
class Test_element_melting_point:     
    def test_BY_value_attribute(self):
        page = PubChem_Periodic_Table_Melting_Point(self.driver)
